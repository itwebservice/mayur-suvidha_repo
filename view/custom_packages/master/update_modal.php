                ...
                <table style="width: 100%" id="dynamic_table_list_update" name="dynamic_table_list_update" class="table table-bordered table-hover table-striped no-marg pd_bt_51 mg_bt_0">
                        ...
                        while($sq_pckg1 = mysql_fetch_assoc($sq_pckg_a)){ ?>
                          <tr>
                            ...
                            <td class='col-md-1 pad_8'><input maxlength="15" value="<?php echo $count; ?>" type="text" name="username" placeholder="Sr. No." class="form-control mg_bt_10" disabled="" autocomplete="off" data-original-title="" title="" style='width:10px'></td>
                            ...
                            <td class='col-md-1 pad_8'><button type="button" id="add_itinerary<?php echo $count; ?>" class="btn btn-info btn-sm" title="Add Itinerary" onClick="add_itinerary('dest_name_u','special_attaraction<?php echo $count; ?>-u','day_program<?php echo $count; ?>-u','overnight_stay<?php echo $count; ?>-u')"><i class="fa fa-plus"></i></button>
                            </td>
