				...
				<div class="panel-group main_block" id="accordion" role="tablist" aria-multiselectable="true">
					...
					<div class="panel panel-default main_block">
						...
						<div id="collapse2" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading2">
							...
							<div class="row mg_bt_10">
								<div class="col-md-12 text-right text_center_xs">
									<button type="button" class="btn btn-info btn-sm ico_left" onClick="hotel_save_modal_direct('tbl_package_hotel_master')"><i class="fa fa-plus"></i>&nbsp;&nbsp;Hotel</button>
              						<button type="button" class="btn btn-info btn-sm ico_left" onClick="addRow('tbl_package_hotel_master');city_lzloading('select[name^=city_name]')"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</button>
              						<button type="button" class="btn btn-danger btn-sm ico_left" onClick="deleteRow('tbl_package_hotel_master')"><i class="fa fa-times"></i>&nbsp;&nbsp;Delete</button>
								</div>
							</div>
							<div class="row mg_bt_10">
								<div class="col-md-12">
						...
						<div id="collapse2" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading3">
							...
							<div class="row mg_bt_10">
								<div class="col-md-12 text-right text_center_xs">
									...
									<button type="button" class="btn btn-info btn-sm ico_left" onClick="addRow('tbl_group_tour_quotation_dynamic_plane');"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</button>
              						<button type="button" class="btn btn-danger btn-sm ico_left" onClick="deleteRow('tbl_group_tour_quotation_dynamic_plane')"><i class="fa fa-times"></i>&nbsp;&nbsp;Delete</button>
								</div>
							</div>
							<div class="row mg_bt_10">
								<div class="col-md-12">
