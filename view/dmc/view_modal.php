							        		...
							        		<div class="row">
							        			...
							        			<div class="col-md-6">
													...
													<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Portal Link <em>:</em></label> " .$sq_dmc['portal_link']; ?>
													...
													<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Username <em>:</em></label> " .$sq_dmc['username']; ?>
													...
													<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Password <em>:</em></label> " .$sq_dmc['password']; ?>
