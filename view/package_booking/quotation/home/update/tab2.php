		                      ...
		                      ?>
		                        <tr>
			                          ...
			                          <td><select id="meal_plan<?php echo $offset; ?>" title="Meal Plan" name="meal_plan" class="form-control mg_bt_10" style='width: 90px'>
									   ...
									   <td class='col-md-1 pad_8'><button type="button" class="btn btn-info btn-sm" title="Add Itinerary" onClick="add_itinerary('dest_name','special_attaraction<?php echo $offset; ?>-u','day_program<?php echo $offset; ?>-u','overnight_stay<?php echo $offset; ?>-u')"><i class="fa fa-plus"></i></button>
                          			  </td>
