                  ...
                  <div class="col-md-12 no-pad" id="div_list1">
                    ...
                    <div class="table-responsive">
                      ...
                      <tr>
                          ...
                          <td class='col-md-1 pad_8'><button type="button" class="btn btn-info btn-sm" title="Add Itinerary" onClick="add_itinerary('dest_name','special_attaraction<?php echo $offset; ?>','day_program<?php echo $offset; ?>','overnight_stay<?php echo $offset; ?>')"><i class="fa fa-plus"></i></button>
                          </td>
