                ...
                <div class="row">
                    ...
                    <table style="width:100%" id="package_program_list" name="package_program_list" class="table mg_bt_0 table-bordered">
                        ...
                        <?php while($row_tours = mysql_fetch_assoc($sq_tours)){
                            ...
                            <td class='col-md-1 pad_8'><button type="button" class="btn btn-info btn-sm" title="Add Itinerary" onClick="add_itinerary('dest_name','special_attaraction<?php echo $count; ?>-u','day_program<?php echo $count; ?>-u','overnight_stay<?php echo $count; ?>-u')"><i class="fa fa-plus"></i></button>
                            </td>
