...
<div class="app_panel_content Filter-panel">
      ...
      <div class="row">
          ...
          <table id="package_program_list" name="package_program_list" class="table mg_bt_0 table-bordered">
              ...
              <td class='col-md-1 pad_8'><button type="button" class="btn btn-info btn-sm" title="Add Itinerary" onClick="add_itinerary('dest_name2','special_attaraction','day_program','overnight_stay')"><i class="fa fa-plus"></i></button>
              </td>
