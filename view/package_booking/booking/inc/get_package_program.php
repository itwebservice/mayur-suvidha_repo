      ...
      <div class="row">
          ...
          <table style="width:100%" id="package_program_list" name="package_program_list" class="table mg_bt_0 table-bordered">
              ...
              <?php while($row_tours = mysql_fetch_assoc($sq_tours)){?>
                ...
                <td class='col-md-1 pad_8'><button type="button" class="btn btn-info btn-sm" title="Add Itinerary" onClick="add_itinerary('dest_name2','special_attaraction<?= $count?>-u','day_program<?= $count?>-u','overnight_stay<?= $count?>-u')"><i class="fa fa-plus"></i></button>
                </td>
                </tr>
              <?php $count++; } ?>
              </tbody>
