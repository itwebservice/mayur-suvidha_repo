...
$qDetails = mysql_fetch_assoc(mysql_query("SELECT `hotel_details`,`enquiry_details`,`costing_details` FROM `hotel_quotation_master` WHERE `quotation_id` =".$quotation_id));
